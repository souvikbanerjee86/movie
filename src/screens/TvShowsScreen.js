...
import { discoverTvShow } from "../actions/tvActions";
...
const TvShowsScreen = () => {
   ...
   const discoverTvShows = useSelector((state) => state.discoverTvShows);
   const { loading, error, dtvshows, page, total_pages } = discoverTvShows;

   useEffect(() => {
      dispatch(discoverTvShow(paginate, sort));
